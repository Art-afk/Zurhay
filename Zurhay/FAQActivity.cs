...
namespace Zurhay
{
    [Activity(Label = "FAQActivity", Theme = "@style/MyTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class FAQActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            FAQWebView.LoadUrl("file:///android_asset/www/FAQ/FAQ.html");
