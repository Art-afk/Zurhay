...
namespace Zurhay
{
    [Activity(Label = "WhatisBuddizmActivity", Theme = "@style/MyTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class WhatisBuddizmActivity : Activity
...

    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            centralname.Text = "Что такое буддизм";
            ...
            FAQWebView.LoadUrl("file:///android_asset/www/WhatIsBuddizm/index.html");
