...
namespace Zurhay
{
    [Activity(Label = "SanghaRussiaActivity", Theme = "@style/MyTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class SanghaRussiaActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            centralname.Text = "Сангха России";
          ...
          Button  bt_exit_from_layout_FAQ = FindViewById<Button>(Resource.Id.bt_exit_from_layout_FAQ);
            ...
            FAQWebView.LoadUrl("file:///android_asset/www/SanghaRussia/index.html");
        }
