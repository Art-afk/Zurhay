...
namespace Zurhay
{
    [Activity(Label = "WhayIsZurhayActivity", Theme ="@style/MyTheme", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class WhayIsZurhayActivity : Activity
    
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            centralname.Text = "Что такое Зурхай";
            ...
            FAQWebView.LoadUrl("file:///android_asset/www/WhatIsZurhay/index.html");

            //\WhatIsZurhay\index.html
